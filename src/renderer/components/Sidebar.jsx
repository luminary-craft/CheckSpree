  ...
  return (
    <div className="side">
      ...
      <div className="sidebar-mode-tabs">
        <button
          className={`sidebar-mode-tab ${sidebarMode === 'check' ? 'active' : ''}`}
          onClick={() => setSidebarMode('check')}
        >
          <span className="sidebar-mode-tab-icon">✏️</span>
          Check
        </button>
        <button
          className={`sidebar-mode-tab ${sidebarMode === 'design' ? 'active' : ''}`}
          onClick={() => setSidebarMode('design')}
        >
          <span className="sidebar-mode-tab-icon">🎨</span>
          Design
        </button>
        <button
          className={`sidebar-mode-tab ${sidebarMode === 'settings' ? 'active' : ''}`}
      ...
      <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', padding: '12px' }}>
          ...
          <>
                  ...
                  {editingBalance ? (
                    ...
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <div style={{ fontSize: '11px', color: '#9ca3af', marginTop: '4px' }}>
                        {(!preferences.adminLocked || preferences.allowUserLedgerManagement) ? 'Click to view ledger history' : 'Click to view'}
                      </div>
                    </div>
                  )}
            ...
            <section className="section-main">
              ...
              <div className="card card-main" style={{ overflow: 'visible' }}>
                ...
                {/* External/Internal Memo - Only in standard mode */}
                {activeProfile?.layoutMode !== 'three_up' && (
                  <>
                    <div className="field">
            ...
            <section className="section">
              ...
              {signature && (
                <SignaturePad
                  ...
                  onSaveDrawn={(dataUrl) => signature.updateSignature({ imageDataUrl: dataUrl, enabled: true })}
                />
              )}
            </section>
            ...
            {!preferences.adminLocked ? (
              ...
              <section className="section">
                <div className="card" style={{ padding: '24px', textAlign: 'center' }}>
                  ...
                  <div style={{ color: 'var(--text-label)', fontSize: '14px', marginBottom: '8px' }}>Admin Locked</div>
                  <div style={{ color: 'var(--text-dim)', fontSize: '12px' }}>
                    Unlock admin from the Admin menu in the top bar to access settings.
                  </div>
                </div>
              </section>
            )}
        ...
        {/* Selected Field - shows in ALL modes when editMode is active */}
        {editMode && (
          <section className="section">
            <div className="card">
