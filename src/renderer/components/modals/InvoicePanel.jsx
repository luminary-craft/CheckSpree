...
export function InvoicePanel({ invoiceHook, onClose, showToast, preferences, setPreferences, onRecordDeposit, onReverseDeposit, activeLedgerId, ledgers = [] }) {
  ...
  const handleSavePdfFromList = (invoice) => {
    setPreviewInvoice(invoice)
    triggerSavePdf(invoice)
  }
                      ...
                      <div key={inv.id} className={`panel-list-item ${borderClass}`}>
                        ...
                        <div style={{ textAlign: 'right', flexShrink: 0 }}>
                          ...
                          <div style={{ display: 'flex', gap: '4px', marginTop: '4px', justifyContent: 'flex-end' }}>
                            ...
                            <button className="btn-icon-sm" onClick={() => handleSavePdfFromList(inv)} title="Save PDF">
